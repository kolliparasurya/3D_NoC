...
#include "Hotspot_temperature_block.h"
...
thermal_config_t default_thermal_config(void)
{
	...
	config.thermal_threshold = 36.8 + 273.15;
	...
	/* heat spreader specs	*/
	config.s_spreader = 40e-3;          /* spreader side in m	*/
	...
	config.grid_rows = 128;				/* grid resolution - no. of rows	*/
	config.grid_cols = 128;				/* grid resolution - no. of cols	*/
